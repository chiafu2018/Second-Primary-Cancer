...
for seed in range(10, 43):
    ...
    process6 = subprocess.Popen(f'python mainXgboost.py --seed={seed} --hospital=1', shell=True)
    process7 = subprocess.Popen(f'python mainXgboost.py --seed={seed} --hospital=2', shell=True)
